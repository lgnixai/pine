...
use crate::lexer::token::{Modifier, Operator};
...
pub enum ExportDefaultElement {
    ...
    ClassDeclaration(Positioned<ClassDeclaration>),
    Expression(Positioned<Expression>),
    IdentifierReference(Positioned<Identifier>),
}
...
pub struct ClassDeclaration {
    ...
    pub extends: Vec<Positioned<Identifier>>,
    pub implements: Vec<Positioned<Identifier>>,
...
pub struct MemberAccessorDeclaration {
    ...
    pub name: Positioned<PropertyName>,
    pub parameter: Option<Positioned<Identifier>>,
...
pub struct ExportSpecifier {
    pub property_name: Option<Positioned<Identifier>>,
    pub name: Positioned<Identifier>,
}
...
pub enum ImportClause {
    Named(Positioned<Identifier>),
    NamedImports(Vec<Positioned<ImportSpecifier>>),
    NamespaceImport(Positioned<Identifier>),
}
...
pub enum PrimaryType {
    ...
    TypeReference(Identifier, Vec<Identifier>),
...
pub enum Expression {
    ...
    Identifier(Positioned<Identifier>),
    Array {
...
pub enum Literal {
    ...
    Int(Positioned<i32>),
    Integer(Positioned<i64>),
    Number(Positioned<i64>),
    Float(Positioned<f64>),
    Double(Positioned<f64>),
    Boolean(Positioned<bool>),
    Variable(Positioned<String>),
